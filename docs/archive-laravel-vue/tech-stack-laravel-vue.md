...
| Package                       | Versão | Status    | Propósito                                |
| ----------------------------- | ------ | --------- | ---------------------------------------- |
| `spatie/laravel-medialibrary` | 11.17  | INSTALADO | **File uploads & attachments** (tickets) |
| `intervention/image`          | 3.11   | INSTALADO | Image processing (avatars, thumbnails)   |
| `league/flysystem-aws-s3-v3`  | 3.30   | MANTIDO   | Storage AWS S3 (manter para futuro)      |
| `maatwebsite/excel`           | 1.1    | INSTALADO | **CSV/Excel import/export** (assets)     |
...
| Package                         | Versão | Status    | Propósito                                         |
| ------------------------------- | ------ | --------- | ------------------------------------------------- |
| `shadcn-vue`                    | latest | INSTALADO | **Headless UI components** (Radix + Tailwind)     |
| `@tiptap/vue-3`                 | latest | INSTALADO | **Rich text editor** (ticket descriptions)        |
| `@tiptap/starter-kit`           | latest | INSTALADO | Tiptap base extensions (bold, italic, etc)        |
| `@tiptap/extension-placeholder` | latest | INSTALADO | Placeholder text for empty editor                 |
...
| `chart.js`                      | latest | INSTALADO | **Data visualization** (dashboard charts)         |
| `vue-chartjs`                   | latest | INSTALADO | Vue 3 wrapper for Chart.js                        |
| `date-fns`                      | latest | INSTALADO | **Date utilities** (SLA calculations, formatting) |
