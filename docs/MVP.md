...
| ---------------- | ------ | --------- | ------------------------ |
| **PHP**          | 8.2    | Produção  | Stable, compatible       |
...
| **Tiptap**       | 2.x    | Instalado | Rich text editor         |
| **Chart.js**     | 4.x    | Instalado | Data visualization       |
| **MediaLibrary** | 11.17  | Instalado | File uploads/attachments |
